...
int main() {
  ...
  v1.print();
  std::cout<<std::endl;
  remove_matching_elements(100, v1);
  v1.print();
  std::cout<<std::endl;
  Vec<float> vTest1;
  //sets every value equal to 20
  for(int i=0;i<30;i++){
    vTest1.push_back(20.0);
  }
  vTest1.print();
  //remove ALL values
  remove_matching_elements(20.0, vTest1);
  vTest1.print();
  //add 3 more values
  vTest1.push_back(1.0);
  vTest1.push_back(2.0);
  vTest1.push_back(3.0);
