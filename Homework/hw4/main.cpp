...
void StudentTests() {
  ...
  //
  JaggedArray<int> intJa(5);
  intJa.addElement(0,3);
  intJa.addElement(0,3);
  intJa.addElement(0,3);
  intJa.addElement(3,2);
  intJa.addElement(3,500);
  intJa.addElement(3,1);
  intJa.addElement(4, 420);
  // ;)
  assert(intJa.numElementsInBin(0)==3);
  assert(intJa.numElementsInBin(3)==3);
  assert(intJa.numElementsInBin(4)==1);
  intJa.print();
  intJa.pack();
  assert(intJa.numElementsInBin(0)==3);
  assert(intJa.numElementsInBin(3)==3);
